...
namespace OHOS {
const double BEZIERARCANGLEEPSILON = 0.01;
                    ...
                    double* curve)
{
    ...
    double sn = std::sin(startAngle + sweepAngle / 2.0);
    double cs = std::cos(startAngle + sweepAngle / 2.0);
                        ...
                        double sweepAngle)
{
    ...
    do
    {
        ...
        ArcToBezier(x, y, rx, ry, 
                        startAngle, 
                        localSweep, 
                        vertices_ + numVertices_ - 2);

        numVertices_ += 6;
        startAngle += localSweep;
    }
    while(!done && numVertices_ < 26);
}
