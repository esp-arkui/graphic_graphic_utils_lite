                        ...
                        double rx3, double ry3, double rx4, double ry4)
{
    ...
    rx3_ = rx3; ry3_ = ry3; rx4_ = rx4; ry4_ = ry4;
}
...
void RoundedRect::NormalizeRadius()
{
    ...
    double k = 1.0;
    double t;
    t = dx / (rx1_ + rx2_); if(t < k) k = t; 
    t = dx / (rx3_ + rx4_); if(t < k) k = t; 
    t = dy / (ry1_ + ry2_); if(t < k) k = t; 
    t = dy / (ry3_ + ry4_); if(t < k) k = t; 

    if(k < 1.0)
    {
        rx1_ *= k; ry1_ *= k; rx2_ *= k; ry2_ *= k;
        rx3_ *= k; ry3_ *= k; rx4_ *= k; ry4_ *= k;
    }
}
