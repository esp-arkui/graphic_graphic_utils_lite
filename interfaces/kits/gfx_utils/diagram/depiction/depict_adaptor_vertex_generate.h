 ...
 * @version 1.0
 */
template <class VertexSource, class Generator, class Markers = EmptyMarkers>
...
uint32_t DepictAdaptorVertexGenerate<VertexSource, Generator, Markers>::GenerateVertex(float* x,
                                                                                       float* y)
{
