...
public:
    ...
    QuadraticBezierCurveIncrement(float x1, float y1,
                                  ...
                                  float x3, float y3)
        : numberSteps_(0),
        currentStep_(0), approximationScale_(1.0f)
    {
...
private:
    ...
    float startXCoordinate_;
    float startYCoordinate_;
    float endXCoordinate_;
    float endYCoordinate_;
    float finalXCoordinate_;
    float finalYCoordinate_;
    float deltaFinalXCoordinate_;
    float deltaFinalYCoordinate_;
    float copyDeltaFinalXCoordinate_;
    float copyDeltaFinalYCoordinate_;
    float savedFinalXCoordinate_;
    float savedFinalYCoordinate_;
    float savedDeltaFinalXCoordinate_;
    float savedDeltaFinalYCoordinate_;
};
...
public:
    ...
    QuadraticBezierCurveDividOperate(float x1, float y1,
                                     float x2, float y2,
                                     float x3, float y3)
        : approximationScale_(1.0f),
        angleTolerance_(0.0f), count_(0)
    {
        Init(x1, y1, x2, y2, x3, y3);
    }
...
private:
    ...
    unsigned count_;
    GraphicGeometryPlainDataBlockVector<PointF> points_;
};
...
private:
    ...
    float copyDeltaFinalXCoordinate_;
    float copyDeltaFinalYCoordinate_;
    float repeatCopyDeltaFinalXCoordinate_;
    float repeatCopyDeltaFinalYCoordinate_;
    float savedFinalXCoordinate_;
    float savedFinalYCoordinate_;
    float savedDeltaFinalXCoordinate_;
    float savedDeltaFinalYCoordinate_;
    float savedCopyDeltaFinalXCoordinate_;
    float savedCopyDeltaFinalYCoordinate_;
};
