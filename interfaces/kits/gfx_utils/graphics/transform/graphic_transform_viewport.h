...
namespace OHOS {
    ...
    public:
        ...
        /**
         * @brief 设定xy轴方向对其的偏移量
         * @param alignX x轴方向偏移量
         * @param alignY y轴方向偏移量
         * @param aspect 外观比例类型
         * @since 1.0
         * @version 1.0
         */
        ...
        /**
         * @brief 设备视图坐标点
         * @param x1 设备视图左上角x轴坐标
         * @param y1 设备视图左上角y轴坐标
         * @param x2 设备视图右上角x轴坐标
         * @param y2 设备视图右上角y轴坐标
         * @since 1.0
         * @version 1.0
         */
        ...
        /**
         * @brief 世界视图坐标点
         * @param x1 世界视图左上角x轴坐标
         * @param y1 世界视图左上角y轴坐标
         * @param x2 世界视图右上角x轴坐标
         * @param y2 世界视图右上角y轴坐标
         * @since 1.0
         * @version 1.0
         */
