...
/**
 * @brief JPEG and PNG, which is disabled by default on Huawei LiteOS.
 */
...
/**
 * @brief GIF, which is disabled by default on Huawei LiteOS.
 */
#ifndef ENABLE_GIF
#define ENABLE_GIF                        0
#endif
...
/**
 * @brief Fully rectangle render everytime, which is disabled by default on Huawei LiteOS.
 */
#ifndef FULLY_RENDER
